...
<div class="container mx-auto md:flex mt-10">
    <div class="md:w-1/2">
        ...
        <div class="p-3 flex items-center gap-4">
            ...
            @endauth
            <p class="font-bold ">{{$post->likes()->count()}} <span class="font-normal"> Likes</p>
        ...
        <form action="{{route('comentarios.destoy',['post' => $post])}}" method="POST">
            @method('DELETE')
            @csrf
            <input type="submit"
    ...
    <div class="shadow bg-white p-5">
        ...
        <form action="{{route('comentarios.store',['post' => $post, 'user' => $user])}}" method="POST">
            @csrf
            <div class="mb-5">
                <label for="comentario" class="mb-2 block uppercase text-gray-500 font-bold">Añadir un comentario</label>
                <textarea 
                 id="comentario"
                 name="comentario" 
        ...
        @endauth
        <div  class="mt-10"> <p class="text-xl font-bold text-center mb-4">Comentarios</p></div>
